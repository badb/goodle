...
public class GoogleAPIController {
	...
	private static final String CLIENT_ID = "143791803062.apps.googleusercontent.com"; // available from the APIs console
	private static final String CALENDAR_READONLY_SCOPE = "https://www.googleapis.com/auth/calendar.readonly";
	private static final String API_KEY = "AIzaSyByBds8YwO4GR4Qci5jnJA74BnXpQy47RM";
		    ...
		    new ClientGoogleApiRequestTransport()
		        ...
		        .create(new Receiver<GoogleApiRequestTransport>() {
		          ...
		          public void onSuccess(GoogleApiRequestTransport transport) {
		            ...
		            String calendarId = "eln69j2rs20ra31bfi90nuotvs@group.calendar.google.com";
